...
/**
 * @ast node
 * @declaredat /home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/lang.ast:7
 * @astdecl MyList : Expr ::= Expr*;
 * @production MyList : {@link Expr} ::= <span class="component">{@link Expr}*</span>;

 */
public class MyList extends Expr implements Cloneable {
  /**
   * @aspect CodeGen
   * @declaredat /home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/CodeGen.jrag:318
   */
   ...
   */
  public MyList clone() throws CloneNotSupportedException {
    MyList node = (MyList) super.clone();
    return node;
  }
  /** @apilevel internal 
   ...
   */
  public MyList treeCopyNoTransform() {
    MyList tree = (MyList) copy();
    if (children != null) {
