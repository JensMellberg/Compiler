...
/**
 * @ast node
 * @declaredat /home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/lang.ast:34
...
protected boolean localIndex_visited = false;
   ...
   * @attribute syn
   * @aspect CodeGen
   * @declaredat /home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/CodeGen.jrag:390
   */
...
protected boolean isUnknown_visited = false;
   ...
   * @attribute syn
   * @aspect UnknownDecl
   * @declaredat /home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/UnknownDecl.jrag:7
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
...
/** @apilevel internal */
protected boolean getUniqueID_visited = false;
  /** @apilevel internal */
  private void getUniqueID_reset() {
    getUniqueID_computed = false;
    
    getUniqueID_value = null;
    getUniqueID_visited = false;
  }
  /** @apilevel internal */
  protected boolean getUniqueID_computed = false;

  /** @apilevel internal */
  protected String getUniqueID_value;

  /**
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/NameAnalysis.jrag:15
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/NameAnalysis.jrag:15")
  public String getUniqueID() {
    ASTState state = state();
    if (getUniqueID_computed) {
      return getUniqueID_value;
    }
    if (getUniqueID_visited) {
      throw new RuntimeException("Circular definition of attribute IdDecl.getUniqueID().");
    }
    getUniqueID_visited = true;
    state().enterLazyAttribute();
    getUniqueID_value = getUniqueID_compute();
    getUniqueID_computed = true;
    state().leaveLazyAttribute();
    getUniqueID_visited = false;
    return getUniqueID_value;
  }
  /** @apilevel internal */
  private String getUniqueID_compute() {
...
protected boolean isVariable_visited = false;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/NameAnalysis.jrag:92
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/NameAnalysis.jrag:92")
...
protected boolean isMultiDeclared_visited = false;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/NameAnalysis.jrag:95
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/NameAnalysis.jrag:95")
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/NameAnalysis.jrag:19
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/NameAnalysis.jrag:19")
  public String getPrefix() {
    ASTState state = state();
    if (getPrefix_computed) {
      return getPrefix_value;
    }
    if (getPrefix_visited) {
      throw new RuntimeException("Circular definition of attribute IdDecl.getPrefix().");
    }
    getPrefix_visited = true;
    state().enterLazyAttribute();
    getPrefix_value = getParent().Define_getPrefix(this, null);
    getPrefix_computed = true;
    state().leaveLazyAttribute();
    getPrefix_visited = false;
    return getPrefix_value;
  }
/** @apilevel internal */
protected boolean getPrefix_visited = false;
  /** @apilevel internal */
  private void getPrefix_reset() {
    getPrefix_computed = false;
    
    getPrefix_value = null;
    getPrefix_visited = false;
  }
  /** @apilevel internal */
  protected boolean getPrefix_computed = false;

  /** @apilevel internal */
  protected String getPrefix_value;
   ...
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/NameAnalysis.jrag:87")
...
protected boolean function_visited = false;
  ...
  /** @apilevel internal */
  protected FuncDecl function_value;

  /**
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/NameAnalysis.jrag:90
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/NameAnalysis.jrag:90")
...
protected java.util.Set lookup_String_visited;
   ...
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/NameAnalysis.jrag:91")
...
protected boolean isFunction_visited = false;
   ...
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/NameAnalysis.jrag:106")
  public Type getType() {
    ASTState state = state();
    if (getType_computed) {
    ...
    if (getType_visited) {
      throw new RuntimeException("Circular definition of attribute IdDecl.getType().");
    }
    getType_visited = true;
    state().enterLazyAttribute();
    getType_value = getParent().Define_getType(this, null);
...
protected boolean getType_visited = false;
   ...
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/NameAnalysis.jrag:138")
...
protected boolean isParam_visited = false;
   ...
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/NameAnalysis.jrag:146")
  public int getParamIndex() {
    ASTState state = state();
    if (getParamIndex_computed) {
      return getParamIndex_value;
    }
    if (getParamIndex_visited) {
      throw new RuntimeException("Circular definition of attribute IdDecl.getParamIndex().");
    }
    getParamIndex_visited = true;
    state().enterLazyAttribute();
    getParamIndex_value = getParent().Define_getParamIndex(this, null);
    getParamIndex_computed = true;
    state().leaveLazyAttribute();
    getParamIndex_visited = false;
    return getParamIndex_value;
  }
/** @apilevel internal */
protected boolean getParamIndex_visited = false;
  /** @apilevel internal */
  private void getParamIndex_reset() {
    getParamIndex_computed = false;
    getParamIndex_visited = false;
  }
  /** @apilevel internal */
  protected boolean getParamIndex_computed = false;

  /** @apilevel internal */
  protected int getParamIndex_value;

  /** @apilevel internal */
  protected void collect_contributors_Program_errors(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /home/jens/school/Compilers/Compilers/FunCompiler/src/jastadd/Errors.jrag:45
    if (isMultiDeclared()) {
      {
